 ...
 */
public class SideTab extends javax.swing.JFrame  {
    ...
    public SideTab() {
        ...
        customerView = new View();
        eventsView = new Events();
    ...
    // Add this method to set up button listeners
     ...
     private void showCustomerInPanel1() {
        ...
        pnlCard1.removeAll();
        pnlCard1.add(customerView.getContentPane());
        pnlCard1.revalidate();
        pnlCard1.repaint();
    ...
    private void showEventsInPanel2() {
        ...
        if (eventsView == null || !eventsView.isVisible()) {
            eventsView = new Events();
        }
        ...
        pnlCard1.removeAll();
        pnlCard1.add(eventsView.getContentPane());
        pnlCard1.revalidate();
        pnlCard1.repaint();
        eventsView.dispose();
    }
